...
#define DUKE_JOYSTICK_MAX  32767
#define DUKE_JOYSTICK_MIN  -32767
...
static const DeviceDescriptor xid_dev_descriptor PROGMEM = D_DEVICE(0x00, 0x00, 0x00, USB_EP_SIZE, USB_VID, USB_PID, 0x0121, 0, 0, 0, 1);
...
typedef struct __attribute__((packed))
{
	uint8_t startByte;
	uint8_t bLength;
	uint8_t lValue_useless;
	uint8_t lValue;
	uint8_t hValue_useless;
	uint8_t hValue;
} usbd_duke_out_t;
